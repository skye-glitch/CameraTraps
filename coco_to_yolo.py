...
class ConvertCOCOToYOLO:
    ...
    def convert(self,annotation_key='annotations',img_id='image_id',cat_id='category_id',bbox='bbox'):
        ...
        for i in range(len(data[annotation_key])):
            ...
            #if image is not in folder, continue
            img = cv2.imread(image_path)
            if img is None:
                print("cannot find {}".format(image_path))
                continue
            print("read in image {}".format(image_path)) 
...
if __name__ == "__main__":
    ConvertCOCOToYOLO(img_folder='/scratch1/07980/sli4/img/train',json_path='/scratch1/07980/sli4/ena24.json').convert()
